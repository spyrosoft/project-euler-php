...
for ($row_counter = 0; $row_counter < count($numbers_grid); $row_counter++) {
	for ($column_counter = 0; $column_counter < count($numbers_grid[0]) - 3; $column_counter++) {
		$current_product = $numbers_grid[$row_counter][$column_counter]
			* $numbers_grid[$row_counter][$column_counter + 1]
			* $numbers_grid[$row_counter][$column_counter + 2]
			* $numbers_grid[$row_counter][$column_counter + 3];
...
for ($row_counter = 0; $row_counter < count($numbers_grid) - 3; $row_counter++) {
	for ($column_counter = 0; $column_counter < count($numbers_grid[0]); $column_counter++) {
		$current_product = $numbers_grid[$row_counter][$column_counter]
			* $numbers_grid[$row_counter + 1][$column_counter]
			* $numbers_grid[$row_counter + 2][$column_counter]
			* $numbers_grid[$row_counter + 3][$column_counter];
		if ($current_product > $largest_product) {
			$largest_product = $current_product;
		}
	}
...
for ($row_counter = 0; $row_counter < count($numbers_grid) - 3; $row_counter++) {
	for ($column_counter = 0; $column_counter < count($numbers_grid[0]) - 3; $column_counter++) {
		$current_product = $numbers_grid[$row_counter][$column_counter]
			* $numbers_grid[$row_counter + 1][$column_counter + 1]
			* $numbers_grid[$row_counter + 2][$column_counter + 2]
			* $numbers_grid[$row_counter + 3][$column_counter + 3];
		if ($current_product > $largest_product) {
			$largest_product = $current_product;
		}
	}
...
for ($row_counter = 0; $row_counter < count($numbers_grid) - 3; $row_counter++) {
	for ($column_counter = 0; $column_counter < count($numbers_grid[0]) - 3; $column_counter++) {
		$current_product = $numbers_grid[$row_counter][$column_counter + 3]
			* $numbers_grid[$row_counter + 1][$column_counter + 2]
			* $numbers_grid[$row_counter + 2][$column_counter + 1]
			* $numbers_grid[$row_counter + 3][$column_counter];
		if ($current_product > $largest_product) {
			$largest_product = $current_product;
		}
